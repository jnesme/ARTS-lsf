...
### General options
#BSUB -q hpc
#BSUB -J arts_smoketest_pseudoalt
#BSUB -n 4
#BSUB -R "span[hosts=1] rusage[mem=8GB]"
#BSUB -M 8400MB
#BSUB -W 3:00
#BSUB -o /work3/josne/github/arts/lsf/logs/arts_smoketest_pseudoalt_%J.out
#BSUB -e /work3/josne/github/arts/lsf/logs/arts_smoketest_pseudoalt_%J.err

set -euo pipefail

#==========================================================================
# ARTS smoke test — Pseudoalteromonas sp. S1608 (solo run)
...
# directly).
#==========================================================================
INPUT="/work3/josne/Projects/Vibrio_Galathea3/pseudoalteromonas_seq/funcscan_results/bgc/antismash/S1608/S1608.gbk"
RESULTDIR="/work3/josne/Projects/Vibrio_Galathea3/arts_results/smoketest/pseudoalteromonas_only"
CPU=4
#==========================================================================
...
echo "=========================================="
echo "ARTS smoke test - Pseudoalteromonas sp. S1608 (solo)"
echo "Host       : $(hostname)"
